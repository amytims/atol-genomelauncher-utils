#!/bin/bash -l
#SBATCH --job-name=p_halophilus-short-read_qc
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
atol-qc-raw-shortread \
    --in results/raw_reads/hic/616646_FISH_BRF_232K7NLT3_CTACAATG-GACTTGAC_S13_R1_001.fastq.gz \
    --in2 results/raw_reads/hic/616646_FISH_BRF_232K7NLT3_CTACAATG-GACTTGAC_S13_R2_001.fastq.gz \
    --adaptors /usr/local/opt/bbmap-38.95-1/resources/adapters.fa \
    --out results/processed_reads/hic/616646_FISH_BRF_232K7NLT3_CTACAATG-GACTTGAC_S13_R1_001.trim.fastq.gz \
    --out2 results/processed_reads/hic/616646_FISH_BRF_232K7NLT3_CTACAATG-GACTTGAC_S13_R2_001.trim.fastq.gz \
