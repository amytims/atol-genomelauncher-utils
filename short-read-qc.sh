...
atol-qc-raw-shortread \
    --in results/raw_reads/hic/package_R1.fastq.gz \
    --in2 results/raw_reads/hic/package_R2.fastq.gz \
    --adaptors /usr/local/opt/bbmap-38.95-1/resources/adapters.fa \
    --out results/processed_reads/hic/package_R1.trim.fastq.gz \
    --out2 results/processed_reads/hic/package_R2.trim.fastq.gz \
    --stats results/qc/package_hic_stats.json \
    --threads 14 --logs results/qc/package_hic_logs
