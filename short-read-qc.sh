#!/bin/bash -l
#SBATCH --job-name=a_agassizii-short-read_qc
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
atol-qc-raw-shortread \
    --in results/raw_reads/hic/616641_FISH_BRF_232K7NLT3_GCAGGTTC-AGAAGCAA_S7_R1_001.fastq.gz \
    --in2 results/raw_reads/hic/616641_FISH_BRF_232K7NLT3_GCAGGTTC-AGAAGCAA_S7_R2_001.fastq.gz \
    --adaptors /usr/local/opt/bbmap-38.95-1/resources/adapters.fa \
    --out results/processed_reads/hic/616641_FISH_BRF_232K7NLT3_GCAGGTTC-AGAAGCAA_S7_R1_001.fastq.gz \
    --out2 results/processed_reads/hic/616641_FISH_BRF_232K7NLT3_GCAGGTTC-AGAAGCAA_S7_R2_001.fastq.gz \
